...
export const RosterCardItem: React.FC<RosterCardItemProps> = ({
  ...
  const handleLongPress = () => {
    console.log('🔥 Long press detected on roster card item');
    setShowAuthModal(true);
  };

  const handleDoublePress = () => {
    console.log('👆👆 Double press detected on roster card item');
  ...
  return (
    <>
      <div
        ...
        className="p-2 text-center cursor-pointer hover:bg-gray-50 transition-colors duration-200 min-h-[32px] flex items-center justify-center"
        style={{
