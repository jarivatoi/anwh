        ...
        <div className="flex items-center justify-center space-x-3 sm:space-x-4">
          ...
          <div className="flex-1 flex justify-center">
            <button
             ...
             className="text-lg sm:text-xl font-semibold text-gray-700 text-center px-3 sm:px-4 py-2 rounded-lg select-none"
              style={{ 
                userSelect: 'none', 
                WebkitUserSelect: 'none',
        ...
        createPortal(
          ...
          >
            ...
            >
              ...
              <div style={{ position: 'relative', padding: '24px', paddingBottom: '16px', borderBottom: '1px solid #e5e7eb', flexShrink: 0 }}>
                <button
                  onClick={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
              ...
              <div style={{ padding: '24px', paddingTop: 0, flexShrink: 0 }}>
                <button
                  onClick={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
