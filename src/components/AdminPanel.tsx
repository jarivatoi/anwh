    ...
    try {
      ...
      for (const entry of entries) {
        try {
          ...
          // NEW: Check if this name was originally from PDF but manually changed to someone else
      ...
      const skippedMessage = duplicateCount > 0 ? ` (${duplicateCount} duplicates/manual changes skipped)` : '';
      
      setNotification({
        message: `✅ PDF import completed: ${successCount} entries added${errorCount > 0 ? `, ${errorCount} failed` : ''}${skippedMessage}`,
